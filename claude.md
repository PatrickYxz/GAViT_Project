...
| GAViT v2 K=16 attentive_spatial + token_feedback | NWPU-RESISC45 | 96.2% | — | 30 epoch, epoch 26 达峰, 31.4M params；收敛比 v1 慢，未超越 v1 |
...
- [x] **GAViT v2 训练** K=16 attentive_spatial + token_feedback（30 epochs）— Val Acc 96.2%
